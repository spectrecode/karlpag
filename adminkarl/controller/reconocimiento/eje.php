...
$arrjson['eje_nombre']   	  = $objfunc->verificarDataPost('eje_nombre');
$arrjson['eje_titulo']   	  = $objfunc->verificarDataPost('eje_titulo');
$arrjson['eje_descripcion']   = $objfunc->verificarDataPost('eje_descripcion');
$arrjson['eje_video']   	  = $objfunc->verificarDataPost('eje_video');
...
if ($arrjson['codigo'] > 0){
	...
	//***Agregamos Galeria
	$objnot 			 	= new Reconocimiento();
	$arrjson['expcod'] 		= $objnot->AgregarEje($arrjson);	
}else{
