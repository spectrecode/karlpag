...
$arrjson['psim_titulo']   		= $objfunc->verificarDataPost('psim_titulo');
$arrjson['psim_descripcion']   	= $objfunc->verificarDataPost('psim_descripcion');
...
if ($arrjson['codigo'] > 0){
	...
	//***Agregamos Galeria
	$objnot 			 	= new Evento();
	$arrjson['galcod'] 		= $objnot->AgregarParticiparSim($arrjson);	
}else{
